        ...
        <div class="row">
            ...
            <div class="col-lg-12 table-margin-top">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    @foreach($paymentPerAgent as $payment)
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('payment.history',$payment->consumer_wallet_id)}}" class="btn btn-info"><i class="fa fa-history"></i></a>
