        ...
        <div class="row">
            ...
            <div class="col-lg-12 table-margin-top">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <?php $i=1; ?>
                    @foreach($feeDisbursement as $fee)
                    <tr>

                        <td>{{$i}}</td>

                        <td>{{$fee['consumer']->first_name.' '.$fee['consumer']->last_name}}</td>
                        <td>{{$fee['consumerFeeDisbursement']['fee_charges']}}</td>
                        <td>{{$fee['reference']}}</td>
                        <td>{{$fee['consumerFeeDisbursement']['agent_code']}}</td>
                        <td>{{$fee['consumerFeeDisbursement']['created_at']}}</td>
