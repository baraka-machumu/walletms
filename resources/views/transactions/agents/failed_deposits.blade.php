            ...
            <div class="col-lg-12 table-margin-top">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    @foreach($failedDeposits as $failedDeposit)
                        ...
                        @if($failedDeposit->status=='0')
                           <?php  $status  =  'Failed';?>

                            @elseif($failedDeposit->status=='1')
                            <?php  $status  =  'Success';?>


                        @elseif($failedDeposit->status=='2')
                            <?php  $status  =  'Pending';?>
                    ...
                    <tr>
                        ...
                        <td>{{$failedDeposit->first_name.' '.$failedDeposit->last_name}}</td>

                        <td>{{$failedDeposit->consumer_wallet_id}}</td>
                        <td>{{$failedDeposit->amount}}</td>
                        <td>{{$failedDeposit->reference}}</td>

                        <td>{{$status}}</td>
                        <td>{{$failedDeposit->created_at}}</td>
                        ...
                        <td>
                            ...
                            <a href="{{route('deposit.history',$failedDeposit->consumer_wallet_id)}}" class="btn btn-info"><i class="fa fa-history"></i></a>
