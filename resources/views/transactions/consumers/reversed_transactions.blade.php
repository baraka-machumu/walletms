        ...
        <div class="row">
            ...
            <div class="col-lg-12 table-margin-top">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <?php $i=1; ?>
                    @foreach($reversedTrans as $reversedTran)

                        <?php  $status  =  '';?>

                        @if($reversedTran->status=='0')
                           <?php  $status  =  'Failed';?>

                            @elseif($reversedTran->status=='1')
                            <?php  $status  =  'Success';?>


                        @elseif($reversedTran->status=='2')
                            <?php  $status  =  'Pending';?>
                    ...
                    <tr>
                        ...
                        <td>{{$reversedTran->first_name.' '.$reversedTran->last_name}}</td>

                        <td>{{$reversedTran->consumer_wallet_id}}</td>
                        <td>{{$reversedTran->amount}}</td>
                        <td>{{$reversedTran->reference}}</td>

                        <td>{{$status}}</td>
                        <td>{{$reversedTran->created_at}}</td>
                        ...
                        <td>
                            ...
                            <a href="{{route('deposit.history',$reversedTran->consumer_wallet_id)}}" class="btn btn-info"><i class="fa fa-history"></i></a>
