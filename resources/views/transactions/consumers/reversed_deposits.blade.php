        ...
        <div class="row">
            ...
            <div class="col-lg-12 table-margin-top">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <?php $i=1; ?>
                    @foreach($reversedDeposits as $reversedDeposit)

                        <?php  $status  =  '';?>

                        @if($reversedDeposit->status=='0')
                           <?php  $status  =  'Failed';?>

                            @elseif($reversedDeposit->status=='1')
                            <?php  $status  =  'Success';?>


                        @elseif($reversedDeposit->status=='2')
                            <?php  $status  =  'Pending';?>
                    ...
                    <tr>
                        ...
                        <td>{{$reversedDeposit->first_name.' '.$reversedDeposit->last_name}}</td>

                        <td>{{$reversedDeposit->consumer_wallet_id}}</td>
                        <td>{{$reversedDeposit->amount}}</td>
                        <td>{{$reversedDeposit->reference}}</td>

                        <td>{{$status}}</td>
                        <td>{{$reversedDeposit->created_at}}</td>
                        ...
                        <td>
                            ...
                            <a href="{{route('deposit.history',$reversedDeposit->consumer_wallet_id)}}" class="btn btn-info"><i class="fa fa-history"></i></a>
