       ...
       <p class="h4-background" style="height: 30px;">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="deposit" role="tabpanel" aria-labelledby="deposit-tab">
              ...
              @include('transactions.consumers.deposits',$deposits)

            </div>
            <div class="tab-pane fade" id="payment" role="tabpanel" aria-labelledby="payment-tab">

                @include('transactions.consumers.payments',$payments)


            </div>
            <div class="tab-pane fade" id="failed" role="tabpanel" aria-labelledby="failed-tab">

                @include('transactions.consumers.failed_deposits',$failedPayments)

            </div>
            <div class="tab-pane fade" id="reversed" role="tabpanel" aria-labelledby="reversed-tab">

                @include('transactions.consumers.reversed_deposits',$reversedPayments)
...
@section('js')
    ...
    <script>
        $(function () {
            ...
            $('#consumer-deposit').dataTable();
            $('#consumer-payment').dataTable();
