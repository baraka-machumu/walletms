        ...
        <div class="row">
            ...
            <div class="col-lg-12 table-margin-top">
                ...
                <table class="table table-bordered table-striped" id="consumer-payment">
                    ...
                    <tr>
                        <td>{{$i}}</td>
                        <td>{{$payment['consumer']->first_name.' '.$payment['consumer']->last_name}}</td>

                        <td>{{$payment->consumer_wallet_id}}</td>
                        <td>{{$payment->total_price}}</td>
                        <td>{{$payment->reference}}</td>

                        @if($payment->recipient_type===3)

                        <td>{{$payment['merchant']->name}}</td>
                            @elseif($payment->recipient_type===4)

                            <td>{{$payment['consumerRecipient']->first_name}}</td>
                        ...
                        <td>
                            ...
                            <a href="{{url('consumer-transactions/payment-history',$payment->consumer_wallet_id)}}" class="btn btn-info"><i class="fa fa-history"></i></a>
