        ...
        <div class="row">
            ...
            <div class="col-lg-12 table-margin-top">
                ...
                <table class="table table-bordered table-striped" id="consumer-deposit">
                    ...
                    <tr>
                        ...
                        <td>{{$deposit['consumerDeposits']->first_name.' '.$deposit['consumerDeposits']->last_name}}</td>

                        <td>{{$deposit->consumer_wallet_id}}</td>
                        <td>{{$deposit->amount}}</td>
                        <td>{{$deposit->ncard_reference}}</td>
                        @if($deposit->gateway_type == 1)
                        <td>{{$deposit['agent']['first_name'].' '.$deposit['agent']['last_name']}}</td>
                        @elseif($deposit->gateway_type == 2)
                            <td>{{$deposit['consumer_deposit']['first_name'].' '.$deposit['consumer_deposit']['last_name']}}</td>
                            @endif
                        ...
                        <td>
                            ...
                            <a href="{{url('consumer-transactions/deposit-history',$deposit->consumer_wallet_id)}}" class="btn btn-info"><i class="fa fa-history"></i></a>
