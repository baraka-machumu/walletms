            ...
            <div class="col-lg-12 table-margin-top">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    @foreach($failedPayments as $failedPayment)
                        ...
                        @if($failedPayment->status=='0')
                           <?php  $status  =  'Failed';?>

                            @elseif($failedPayment->status=='1')
                            <?php  $status  =  'Success';?>


                        @elseif($failedPayment->status=='2')
                            <?php  $status  =  'Pending';?>
                    ...
                    <tr>
                        ...
                        <td>{{$failedPayment->first_name.' '.$failedPayment->last_name}}</td>

                        <td>{{$failedPayment->consumer_wallet_id}}</td>
                        <td>{{$failedPayment->amount}}</td>
                        <td>{{$failedPayment->reference}}</td>

                        <td>{{$status}}</td>
                        <td>{{$failedPayment->created_at}}</td>
                        ...
                        <td>
                            ...
                            <a href="{{route('deposit.history',$failedPayment->consumer_wallet_id)}}" class="btn btn-info"><i class="fa fa-history"></i></a>
