...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <button type="button" data-toggle="modal" data-target="#create-permission-modal" class="btn btn-cyan btn-sm" id="previous">New Permission</button>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    @foreach($permissions as $permission)
                        ...
                        <tr>
                            ...
                            <td>
                                <a id="{{$permission['id']}}" data-id="{{ $permission['id']}}" href="#" class="btn btn-success edit-permissions"><i class="fa fa-edit"></i></a>
    ...
    <!-- Modal -->
    <div class="modal fade bd-example-modal-lg" id="create-permission-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <form method="post" action="{{url('access/permissions')}}">
    ...
    <!-- Modal -->
    <div class="modal fade bd-example-modal-lg" id="edit-permission-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
